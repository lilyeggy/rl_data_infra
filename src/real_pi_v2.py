"""Build the V2 decision package from captured, sanitized Pi executions."""
...
def verify_reference_answer(
    records: Iterable[Mapping[str, Any]], *, task_index: int
...
def generate_real_pi_v2(
    ...
    *,
    ...
    fixtures = (
        ...
        else Path(__file__).parents[1] / "tests" / "fixtures" / "pi" / "v2-real"
    )
    experiment = ExperimentManifest(
