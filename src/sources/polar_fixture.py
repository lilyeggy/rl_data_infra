"""Offline Polar fixture importer; this module never runs a live Polar service."""
...
class PolarFixtureImporter:
    ...
    def convert(self, payload: object) -> AdapterResult:
        if not isinstance(payload, (str, Path)):
            return self._adapter_error("PolarFixtureImporter expects a fixture directory path")
