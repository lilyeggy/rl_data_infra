> **已归档：双 Blackwell 历史环境，请勿作为当前执行计划。** 当前权威范围见 `PROJECT_SCOPE.md`，
> 实施顺序见 `IMPLEMENTATION_PLAN.md`，Day 1 以 `plans/day-01-environment.md` 为准。
> 本文件仅保留最初服务器执行背景，后续不再更新。

# Day 1：官方基线、硬件环境与数据契约（历史版本）
