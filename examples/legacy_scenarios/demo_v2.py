"""HISTORICAL EXAMPLE: V2 entry point and synthetic mechanism fixture."""
...
def generate_synthetic_v2_demo(output_dir: str | Path) -> dict[str, Any]:
    ...
    fixture_path = Path(__file__).parents[2] / "tests" / "fixtures" / "pi" / "gpt56_luna_probe.ndjson"
...
def generate_v2_demo(output_dir: str | Path) -> dict[str, Any]:
    ...
    from examples.legacy_scenarios.real_pi_v2 import generate_real_pi_v2
